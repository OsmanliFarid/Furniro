  ...
  return (
    <>
      <div className="bg-[url(/images/HomeBackground.png)] bg-cover bg-center h-[812px]">
        <div className="max-w-[85vw] m-auto   h-full">
          <div className="flex justify-center items-center md:justify-end md:items-end md:pb-25 h-full">
            <div className="bg-[#FFF3E3] w-[643px]  h-auto md:h-[443px]">
